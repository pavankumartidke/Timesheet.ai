...
# # Step 1: Get the active window's title
...
# # Step 2: Take a screenshot of the full screen
...
# # Step 3: Perform OCR using Tesseract on the screenshot
...
# # Step 4: Monitor window changes and analyze screenshots
# def monitor_active_window(interval=10):
#     """Continuously monitor the active window and extract text from screenshots."""
#     last_active_window = get_active_window()
#     print(f"Initial active window: {last_active_window}")
...
#             # If the active window changes, take a screenshot and analyze
#             if current_window != last_active_window:
#                 print(f"\nActive window changed to: {current_window}")
#                 last_active_window = current_window

#             # Take a screenshot
#             screenshot_path = take_screenshot(f"screenshot_{int(time.time())}.png")
...
#     print("Starting window monitoring and OCR...")
#     monitor_active_window(interval=10)  # Check every 10 seconds
